...
class InstituteRepositoryTest extends \Codeception\TestCase\Test
{
    ...
    {
        // Given
        $institute = TestDummy::build('Psyao\Resume\Institute', ['name' => 'Foobar']);
    ...
    {
        // Given
        TestDummy::times(5)->create('Psyao\Resume\Institute');
    ...
    {
        // Given
        TestDummy::create('Psyao\Resume\Institute', ['name' => 'Foobar']);

        // When
        /** @var Psyao\Resume\Institute $institute */
